...
BeginRecord:
    ...
    MOVLW 0x0A
    MOVWF CURRENTADRESS ;Sets the adress to start at 10
OUTPUT:
    CALL Write ;Write W to EEPROM
    CALL Read
    MOVWF PORTC
Recording:
    BTFSC PORTA, 1 ;Is stop pressed?
...
Read:
    ...
    BSF STATUS, 6
    MOVLW 0x0A ; (Optional) Load desired address into W
...
WaitRead:
    BTFSC EECON1, 0 ; Checks ((EECON1) and 07Fh), 0
    GOTO WaitRead
...
Write:
    ...
    MOVF CURRENTADRESS, 0 ; Load EEPROM address
    BSF STATUS, 6 ; Bank 2
...
Wait:
    BTFSC EECON1, 1 ; Checks ((EECON1) and 07Fh), 1
    GOTO Wait
    BCF EECON1, 2 ; Disable writes
Wait1:
    BTFSC EECON1, 1 ; Checks ((EECON1) and 07Fh), 1 again...
    GOTO Wait1
...
InterruptHandler:
    ...
    BCF PIR1, 1 ;Clear ((PIR1) and 07Fh), 1
