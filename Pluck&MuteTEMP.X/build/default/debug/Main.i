...
CheckE:
    ...
    BCF PORTB, 0 ;Energize ((PORTB) and 07Fh), 0
    CALL SmallDelay ;Keep enegized
    CLRF STRING ;Clear string
    BSF PORTB, 0 ;De-Energize ((PORTB) and 07Fh), 0
    RETURN
SecondaryRC7:
    BCF PORTC, 7 ;Energize ((PORTC) and 07Fh), 7
    CALL SmallDelay ;Keep enegized
    CLRF STRING ;Clear string
    BSF PORTC, 7 ;De-Energize ((PORTC) and 07Fh), 7
    RETURN;</editor-fold>
...
CheckA:
    ...
    BCF PORTC, 6 ;Energize ((PORTC) and 07Fh), 6
    CALL SmallDelay ;Keep enegized
    CLRF STRING ;Clear string
    BSF PORTC, 6 ;De-Energize ((PORTC) and 07Fh), 6
    RETURN
SecondaryRC5:
    BCF PORTC, 5 ;Energize ((PORTC) and 07Fh), 5
    CALL SmallDelay ;Keep enegized
    CLRF STRING ;Clear string
    BSF PORTC, 5 ;De-Energize ((PORTC) and 07Fh), 5
    RETURN;</editor-fold>
...
CheckD:
    ...
    BCF PORTB, 4 ;Energize ((PORTB) and 07Fh), 4
    CALL SmallDelay ;Keep enegized
    CLRF STRING ;Clear string
    BSF PORTB, 4 ;De-Energize ((PORTB) and 07Fh), 4
    RETURN
SecondaryRB3:
    BCF PORTB, 3 ;Energize ((PORTB) and 07Fh), 3
    CALL SmallDelay ;Keep enegized
    CLRF STRING ;Clear string
    BSF PORTB, 3 ;De-Energize ((PORTB) and 07Fh), 3
    RETURN;</editor-fold>
...
CheckG:
    ...
    BCF PORTB, 2 ;Energize ((PORTB) and 07Fh), 2
    CALL SmallDelay ;Keep enegized
    CLRF STRING ;Clear string
    BSF PORTB, 2 ;De-Energize ((PORTB) and 07Fh), 2
    RETURN
SecondaryRB1:
    BCF PORTB, 1 ;Energize ((PORTB) and 07Fh), 1
    CALL SmallDelay ;Keep enegized
    CLRF STRING ;Clear string
    BSF PORTB, 1 ;De-Energize ((PORTB) and 07Fh), 1
    RETURN;</editor-fold>
