...
Main:
    ...
    MOVLW 0x05 ;Move 5 to W
    Call LookUpTable ;Go get a number from table
    MOVWF PORTB ;Display result on PORTB

LookUpTable:
    ADDWF PCL,1 ;Add W to Program Counter
    RETLW 77 ;select 77 for display & return
    RETLW 42 ;select 42 for display & return
    RETLW 6 ;select 6 for display & return
    RETLW 128 ;select 128 for display & return
    RETLW 25 ;select 25 for display & return
    RETLW 7 ;select 7 for display & return
    RETLW 64 ;select 64 for display & return
