...
FINAL_IMAGE=${DISTDIR}/DelayDotDisplay.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/DelayDotDisplay.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F882
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/DelayDotDisplay.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/DelayDotDisplay.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F882 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/DelayDotDisplay.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
